...
dual.heatmap(upper.thresh, lower.thresh, lowerRampCols=7,label.colors=base.cols2$oc[rownames(counts.mat),],main="Dual Network",png=T,dir="./Pics/",filename="../Pictures/DualNet.png")
...
dual.heatmap(nogs.upper.thresh, nogs.lower.thresh, lowerRampCols=7,label.colors=base.cols2$oc[rownames(nogs.counts),],main="Dual Network - No Global Signal",png=T,dir="./Pics/",filename="../Pictures/DualNet_NoGS.png")
...
dual.heatmap(nogs.min2.upper.thresh, nogs.min2.lower.thresh, lowerRampCols=7,label.colors=base.cols2$oc[rownames(nogs.min2.counts),],main="Dual Network - No Global Signal (Min. 2)",png=T,dir="./Pics/",filename="../Pictures/DualNet_NoGS_Min2.png")
...
dual.heatmap(nogs.min2.upper.thresh_re, nogs.min2.lower.thresh_re, lowerRampCols=7,label.colors=base.cols2$oc[rownames(nogs.min2.counts_re),],main="Dual Network - No Global Signal (Min. 2)",png=T,dir="./Pics/",filename="../Pictures/DualNet_NoGS_Min2_re.png")
